---
date: 2026-05-26
description: "CAP case — non-severe community-acquired pneumonia in COPD/diabetes patient with no recent antibiotic exposure"
disease_state: "CAP"
difficulty: medium
author: "Spencer"
status: approved
case_number: "CAP-03"
challenge_types: [non-severe-CAP, COPD, severity-classification]
tags:
  - sanity-test
  - case
  - cap
...
SS is a 48-year-old male with a past medical history significant for hypertension, type 2 diabetes mellitus, asthma, and COPD who presents to the emergency department with worsening shortness of breath. He reports being in his usual state of health until approximately two weeks ago when he developed symptoms consistent with an upper respiratory illness — rhinorrhea, mild sore throat, myalgias, and low-grade fevers. He initially improved over the following week without seeking medical care. Over the past 3–4 days, however, he has experienced a recurrence and worsening of symptoms, with increasing dyspnea, productive cough with yellow-green sputum, pleuritic chest pain, and subjective fevers up to 100.1°F at home.

On arrival to the ED, vitals are: T 99.8°F (37.7°C), HR 84, BP 138/82, RR 24, SpO2 88% on room air. He appears in moderate respiratory distress and is placed on 2L nasal cannula with improvement to SpO2 94%. Lung exam reveals decreased breath sounds and dullness to percussion at the right base, with focal crackles. He has no known sick contacts, no recent travel, no prior pneumonia history, and no immunosuppressive conditions. He takes lisinopril, amlodipine, metformin, and an albuterol inhaler PRN. He has no documented drug allergies.

A bedside chest X-ray is obtained. Labs are drawn. The ED team is determining appropriate empiric antibiotic therapy and disposition.
...
- Sputum culture: Sent — no growth to date. Gram stain pending.
...
- **Presentation:** Non-severe community-acquired pneumonia
- **Antibiotic Initiation** *(if applicable):* Ceftriaxone 2g IV daily x5 days and azithromycin 500 mg PO x3 days

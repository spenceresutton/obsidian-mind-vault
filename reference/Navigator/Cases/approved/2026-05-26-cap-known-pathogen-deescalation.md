---
date: 2026-05-26
description: "CAP case — non-severe CAP with recent IV abx exposure and known pathogen requiring targeted de-escalation"
disease_state: "CAP"
difficulty: hard
author: "Spencer"
status: approved
case_number: "CAP-08"
challenge_types: [non-severe-CAP, recent-IV-abx-exposure, known-pathogen, de-escalation, targeted-therapy]
tags:
  - sanity-test
  - case
  - cap
...
# CAP Case 8: Non-severe CAP with recent IV abx exposure + known pathogen, requiring de-escalation
...
**Sputum culture:** GPC in pairs and chains. Streptococcus Pneumonia
...
*Resulted: ED presentation day*

## Expected Output

- **Presentation:** Non-severe community acquired pneumonia with risk factors, but a known pathogen (Streptococcus pneumonia)
- **Antibiotic Initiation** *(if applicable):* Ceftriaxone 2g IV q24h x5 days +/- azithromycin 500 mg x3 days
    - Comment that atypical d/c may be warranted
    - Comment that despite risk factors, known pathogen supercedes and should be targeted
- **Treatment Optimization** *(if applicable):* When Navigator is provided information that the Strep pneumonia is penicillin susceptible, it should offer
    - Cefazolin 2g q8h, Ampicillin 2g q4h
    - If ready for Oral: Amox 1000 mg TID, Augmentin 875-125 BID, Cefpodoxime 200 mg BID, Cephalexin 500 q6h are all viable

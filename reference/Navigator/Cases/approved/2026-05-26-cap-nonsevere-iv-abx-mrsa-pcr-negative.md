---
date: 2026-05-26
description: "CAP case — non-severe CAP with recent IV Unasyn and Pseudomonas risk, but negative MRSA nasal PCR"
disease_state: "CAP"
difficulty: hard
author: "Spencer"
status: approved
case_number: "CAP-06"
challenge_types: [non-severe-CAP, recent-IV-abx-exposure, Pseudomonas-risk, MRSA-PCR-negative, de-escalation]
tags:
  - sanity-test
  - case
  - cap
...
# CAP Case 6: Non-severe CAP with recent IV abx exposure + MRSA PCR (-)
...
- **Presentation:** Non-severe community-acquired pneumonia with Pseudomonas risk factors, but negative MRSA PCR
- **Antibiotic Initiation** *(if applicable):* Cefepime 2g q8h IV daily x5 days and azithromycin 500 mg PO x3 days

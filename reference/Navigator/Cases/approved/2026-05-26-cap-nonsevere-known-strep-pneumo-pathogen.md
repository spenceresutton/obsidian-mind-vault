---
date: 2026-05-26
description: "CAP case — non-severe CAP with IV abx risk factors but known Streptococcus pneumoniae on sputum gram stain"
disease_state: "CAP"
difficulty: hard
author: "Spencer"
status: approved
case_number: "CAP-07"
challenge_types: [non-severe-CAP, known-pathogen, Streptococcus-pneumoniae, de-escalation, targeted-therapy]
tags:
  - sanity-test
  - case
  - cap
...
# CAP Case 7: Non-severe CAP with recent IV abx exposure + known pathogen
...
- Sputum culture: GPC in pairs and chains. Streptococcus Pneumoniae identified.
...
- **Presentation:** Non-severe community-acquired pneumonia with risk factors, but a known pathogen (Streptococcus pneumoniae)
- **Antibiotic Initiation** *(if applicable):* Ceftriaxone 2g IV q24h x5 days +/- azithromycin 500 mg x3 days
  ...
  - Comment that despite risk factors, known pathogen supersedes and should be targeted
- **Treatment Optimization** *(if applicable):* When Navigator is provided information that the Strep pneumoniae is penicillin susceptible, it should offer:
  - Cefazolin 2g q8h, Ampicillin 2g q4h
  - If ready for oral: Amoxicillin 1000 mg TID, Augmentin 875-125 BID, Cefpodoxime 200 mg BID, Cephalexin 500 mg q6h are all viable
